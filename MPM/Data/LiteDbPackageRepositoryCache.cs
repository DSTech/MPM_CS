...
namespace MPM.Data {
	...
	public class LiteDbPackageRepositoryCache : IPackageRepositoryCache, IDisposable {
		...
		public LiteDbPackageRepositoryCache(IUntypedKeyValueStore<String> packageCacheDb, IMetaDataManager metaDb, IPackageRepository repository, bool ownsRepositoryInstance = false) {
